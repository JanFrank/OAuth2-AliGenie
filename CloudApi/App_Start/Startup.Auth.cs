    ...
    public partial class Startup
    {
        public void ConfigureAuth(IAppBuilder app)
        {
            var OAuthOptions = new OAuthAuthorizationServerOptions
            {
                ...
                AccessTokenExpireTimeSpan = TimeSpan.FromSeconds(Convert.ToInt64(System.Configuration.ConfigurationManager.AppSettings["tokenExpiresTime"])), //access_token 过期时间
